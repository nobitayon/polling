...
public class AnotherUserProfileService : IUserProfileService
{
    private readonly AnotherUserProfileOptions _simpleTorUserProfileOptions;
    private readonly RestClient _restClient;

    public AnotherUserProfileService(IOptions<AnotherUserProfileOptions> simpleTorUserProfileOptions)
    {
    ...
    {
        var restRequest = new RestRequest("profile");
